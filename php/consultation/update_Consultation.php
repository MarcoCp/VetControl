...
try {
	...
	if ($id and $idclient and $idpet and $date and $consultation and $description and $cost == !null) {
		$update = new Consultation;
		$update->update($id,$idclient,$idpet,$date,$consultation,$description,$cost);
