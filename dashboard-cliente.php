 ...
 <head>
	...
	<title>Clientes | VetControl</title>
				...
				<nav class="navbar navbar-expand-lg">
					...
					<div class="collapse navbar-collapse" id="navbarcontent">
						<div class="list-group">
							...
							<a href="dashboard-cliente.php" class="list-group-item list-group-item-action active"><i class="fa fa-user-o" aria-hidden="true"></i> Clientes</a>
			...
			<div class="col-md-9">
				<div id="acordion" role="tablist">
					<div class="card">
						...
						<div id="insertar-tab" class="collapse show" role="tabpanel" aria-labelledby="insertar" data-parent="#acordion">
							<form method="post" action="php/client/insert_client.php">
								<div class="form-row">
					...
					<div class="card">
						...
						<div id="actualizar-tab" class="collapse" role="tabpanel" aria-labelledby="actualizar" data-parent="#acordion">
							<form method="post" action="php/client/update_client.php">
								<div class="form-row">
									<div class="form-group col-md-4">
										...
										<select name="idclient" id="idclient" class="form-control">
											...
											<?php 
												require('php/class/Vet.class.php');
												$client = new Client;
												$client = $client->select();

												 while ($row = mysqli_fetch_assoc($client)) {
												 	echo "<option value=".$row['idClientes'].">".$row['idClientes']."</option>";
												 }
											 ?>
										</select>										
									</div>
				...
				<div class="card">
					<div class="card-body">
						...
						<input type="search" id="search-client" name="search-client" placeholder="Buscar" class="form-control">
						<div id="table-search-client"></div>
					</div>
				</div>							
			</div>
